...
/**
 * Tester class, or "client" class, with main(). It creates a few instances of
 * com.entertainment.Television and gives them a test-drive, i.e., sets their properties and calls
 * their methods.
 */
class TelevisionClient {
  ...
  public static void main(String[] args) {
    ...
    // create an instance of com.entertainment.Television, set its properties, then call methods on
    // it
